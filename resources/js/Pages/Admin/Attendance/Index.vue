            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <Card>
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                        <PageHeader
                            title="Attendance"
                            :description="`Select a class to take or view attendance. ${classes.total} classes total.`"
                        />
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                                <tr v-for="cls in classes.data" :key="cls.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium space-x-3">
                                        <Link
                                            :href="route('admin.attendance.take', cls.id)"
                                            class="text-primary-600 dark:text-primary-400 hover:text-primary-900 dark:hover:text-primary-300"
                                        >
                                            Take Attendance
                                        </Link>
                                        <Link
                                            :href="route('admin.attendance.summary', cls.id)"
                    ...
                    <div class="md:hidden space-y-4">
                        ...
                        >
                            ...
                            <div class="mt-3 flex gap-2">
                                <Link
                                    :href="route('admin.attendance.take', cls.id)"
                                    class="flex-1 block text-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-700 min-h-[44px] flex items-center justify-center"
                                >
                                    Take Attendance
                                </Link>
                                <Link
                                    :href="route('admin.attendance.summary', cls.id)"
                                    class="flex-1 block text-center rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 min-h-[44px] flex items-center justify-center"
                                >
                                    Summary
                                </Link>
                            </div>
