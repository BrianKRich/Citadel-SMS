...
function submit() {
    if (form.ssn === props.student.masked_ssn) {
        form.ssn = '';
    }
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Enter a new SSN to replace, or leave as-is to keep current.</p>
