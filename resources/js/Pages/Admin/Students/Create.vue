...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Add Student</h2>
        </template>
                    ...
                    <form @submit.prevent="submit" class="space-y-8" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p v-if="form.errors.gender" class="mt-1 text-sm text-red-600 dark:text-red-400">
                                    {{ form.errors.gender }}
                                </p>
                            </div>
                            ...
                            <!-- SSN -->
                            <div>
                                <label for="ssn" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                ...
                                />
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Optional. Enter with or without dashes.</p>
                                <p v-if="form.errors.ssn" class="mt-1 text-sm text-red-600 dark:text-red-400">
                                    {{ form.errors.ssn }}
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm"
                                    />
                                    <p v-if="form.errors.postal_code" class="mt-1 text-sm text-red-600 dark:text-red-400">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm"
                                />
                                <p v-if="form.errors.emergency_contact_name" class="mt-1 text-sm text-red-600 dark:text-red-400">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-4 gap-3">
                                    <div class="col-span-1">
                                        <input
                                            id="emergency_phone_area_code"
                                            v-model="form.emergency_phone_area_code"
                                            type="text"
                                            maxlength="3"
                                            placeholder="555"
                                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm"
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Area code and 7-digit number</p>
                                <p v-if="form.errors.emergency_phone_area_code" class="mt-1 text-sm text-red-600 dark:text-red-400">
                                    {{ form.errors.emergency_phone_area_code }}
                                </p>
                                <p v-if="form.errors.emergency_contact_phone" class="mt-1 text-sm text-red-600 dark:text-red-400">
