...
function submit() {
    form.post(route('admin.grading-scales.store'));
}
</script>
                ...
                <Card>
                    <div class="mb-6">
                        <PageHeader
                            ...
                            description="Define letter grades, minimum percentages, and GPA points"
                        />
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            <PrimaryButton type="submit" :disabled="form.processing">
                                {{ form.processing ? 'Saving...' : 'Save Grading Scale' }}
                            </PrimaryButton>
                            <Link
