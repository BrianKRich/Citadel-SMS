...
const form = useForm({
    course_id: props.category.course_id || '',
...
function submit() {
    form.put(route('admin.assessment-categories.update', props.category.id));
}
</script>
                ...
                <Card>
                    <div class="mb-6">
                        <PageHeader
                            ...
                            description="Update this assessment category's details"
                        />
                    </div>
