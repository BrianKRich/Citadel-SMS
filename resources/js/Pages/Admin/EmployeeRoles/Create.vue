...
function submit() {
    form.post(route('admin.employee-roles.store'));
}
</script>

<template>
    <Head title="New Employee Role" />
        ...
        <div class="py-12">
            <div class="mx-auto max-w-2xl sm:px-6 lg:px-8 space-y-6">
                <Breadcrumb :items="[
                    ...
                    { label: 'Employee Roles', href: route('admin.employee-roles.index') },
                    { label: 'New Role' },
                ]" />

                <Card>
                    <PageHeader title="New Employee Role" />
                    ...
                    <form @submit.prevent="submit" class="mt-6 space-y-5">
                        <div>
                            ...
                            <p v-if="form.errors.department_id" class="mt-1 text-xs text-red-600 dark:text-red-400">{{ form.errors.department_id }}</p>
                        </div>
