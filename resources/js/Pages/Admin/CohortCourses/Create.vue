...
// Reset instructor fields when type changes
...
<template>
    <Head title="Add Course Assignment" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Add Course Assignment</h2>
        </template>
            ...
            <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
                ...
                <Card>
                    ...
                    <form @submit.prevent="submit" class="mt-6 space-y-6">
                        ...
                        <!-- Technical college or university: institution dropdown -->
                        <div v-if="form.instructor_type === 'technical_college' || form.instructor_type === 'university'">
                            ...
                            <p v-if="filteredInstitutions.length === 0" class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                No institutions of this type found. <Link :href="route('admin.institutions.create')" class="text-primary-600 dark:text-primary-400 hover:underline">Add one</Link>.
                            </p>
