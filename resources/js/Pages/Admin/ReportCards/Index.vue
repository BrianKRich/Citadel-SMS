...
const termId = ref(props.selectedTermId || props.currentTerm?.id || null);
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <Card>
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                        <PageHeader
                            title="Report Cards"
                            :description="`Select a student to view or download their report card. ${students.total} active students.`"
                        />
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                                <tr v-for="student in students.data" :key="student.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium space-x-3">
                                        <Link
                                            :href="route('admin.report-cards.show', { student: student.id, term_id: termId })"
                                            class="text-primary-600 dark:text-primary-400 hover:text-primary-900 dark:hover:text-primary-300"
                                        >
                                            Preview
                                        </Link>
                                        <a
                                            :href="route('admin.report-cards.pdf', { student: student.id, term_id: termId })"
                                            target="_blank"
