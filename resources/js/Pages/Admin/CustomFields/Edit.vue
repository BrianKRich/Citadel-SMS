...
function submit() {
    form.put(route('admin.custom-fields.update', props.field.id));
}
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Edit Custom Field</h2>
        </template>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
                <Breadcrumb :items="[
                    ...
                    { label: 'Custom Fields', href: route('admin.custom-fields.index') },
                    { label: 'Edit Field' },
                ]" />
                ...
                <Card>
                    <div class="mb-6">
                        <PageHeader
                            ...
                            description="Update this custom field definition"
                        />
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Current name: <code class="font-mono">{{ field.name }}</code>
                                <template v-if="namePreview !== field.name">
                                    → new name: <code class="font-mono">{{ namePreview }}</code>
                                </template>
                            </p>
