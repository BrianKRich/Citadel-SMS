...
const form = useForm({
    ...
    assessment_category_id: props.assessment.assessment_category_id,
    name: props.assessment.name,
    max_score: props.assessment.max_score,
    due_date: props.assessment.due_date ? props.assessment.due_date.substring(0, 10) : '',
    weight: props.assessment.weight || '',
    is_extra_credit: props.assessment.is_extra_credit,
    status: props.assessment.status,
});

function submit() {
    form.put(route('admin.assessments.update', props.assessment.id));
}
</script>
                ...
                <Card>
                    <div class="mb-6">
                        <PageHeader
                            ...
                            description="Update this assessment's details"
                        />
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            <PrimaryButton type="submit" :disabled="form.processing">
                                {{ form.processing ? 'Saving...' : 'Update Assessment' }}
                            </PrimaryButton>
                            <Link
