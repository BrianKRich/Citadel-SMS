...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Add Institution</h2>
        </template>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
                ...
                <Card>
                    <PageHeader title="New Institution" description="Add a partner technical college or university." />
                    ...
                    <form @submit.prevent="submit" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                v-model="form.name"
                                type="text"
                                placeholder="e.g. Georgia Northwestern Technical College"
                                required
                                :class="inputClass"
                            />
