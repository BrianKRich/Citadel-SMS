...
class EnrollmentTest extends TestCase
{
    ...
    public function test_enroll_creates_enrollment_and_redirects(): void
    {
        ...
        $cc      = $this->makeClassCourse(['status' => 'open', 'max_students' => 30]);
    ...
    public function test_enroll_validates_required_fields(): void
    {
        $this->actingAs($this->admin())
            ->post(route('admin.enrollment.enroll'), [])
            ->assertSessionHasErrors(['student_id', 'class_course_id']);
    }
    ...
    public function test_enroll_rejects_full_class_course(): void
    {
        $student1 = Student::factory()->create();
        $student2 = Student::factory()->create();
        $cc       = $this->makeClassCourse(['status' => 'open', 'max_students' => 1]);
        Enrollment::factory()->create([
    ...
    public function test_enroll_rejects_non_open_class_course(): void
    {
        $student = Student::factory()->create();
        $cc      = $this->makeClassCourse(['status' => 'closed', 'max_students' => 30]);
